...
git merge --no-ff -m "feature1" feature1

git checkout team2_sprint

git merge --no-ff -m "feature3" feature3

git checkout team1_sprint

git merge --no-ff -m "feature2" feature2

git checkout team2_sprint

git merge --no-ff -m "feature4" feature4

git checkout develop

git merge --no-ff -m "team1_sprint" team1_sprint

git merge --no-ff -m "team2_sprint" team2_sprint

git checkout master

git merge --no-ff -m "two sprints" develop
...
git merge -m "new release cycle" master
