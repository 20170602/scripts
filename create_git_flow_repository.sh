...
git merge -m "feature1" feature1

git checkout team2_sprint

git merge -m "feature3" feature3

git checkout team1_sprint

git merge -m "feature2" feature2

git checkout team2_sprint

git merge -m "feature4" feature4

git checkout develop

git merge -m "team1_sprint" team1_sprint

git merge -m "team2_sprint" team2_sprint

git checkout master

git merge -m "two sprints" develop
